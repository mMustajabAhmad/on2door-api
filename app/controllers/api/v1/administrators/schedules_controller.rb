class Api::V1::Administrators::SchedulesController < ApplicationController
  before_action :authenticate_administrator!
  load_and_authorize_resource

  def index
    q = @schedules.includes(:subschedules, :driver).ransack(params[:q])
  ...
  private
    def schedule_params
      params.require(:schedule).permit(:date, :driver_id)
    end
end
